...
/* POLAR px */
extern PGDLLIMPORT MemoryContext px_DispatcherContext;
extern PGDLLIMPORT MemoryContext px_InterconnectContext;
extern PGDLLIMPORT MemoryContext px_OptimizerMemoryContext;
/* POLAR end */
