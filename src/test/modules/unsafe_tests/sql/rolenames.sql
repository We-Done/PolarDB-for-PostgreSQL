<<<<<<< HEAD:src/test/regress/sql/rolenames.sql
alter system set polar_super_run_as_secdef = off;
select pg_reload_conf();
CREATE OR REPLACE FUNCTION chkrolattr()
=======
CREATE FUNCTION chkrolattr()
>>>>>>> c1ff2d8bc5be55e302731a16aaff563b7f03ed7c:src/test/modules/unsafe_tests/sql/rolenames.sql
...
alter system set polar_super_run_as_secdef = on;
select pg_reload_conf();
=======
